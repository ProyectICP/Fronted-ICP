...
export const useReagent = ( id, reagent, reagentId ) => {
  ...
  const API = (url = getApiUrl('reagents')) => {
    return {
  ...
  const validate = () => {
    ...
    temp.code_cas = data.code_cas === '' ? false : true
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      ...
      formData.append('code_cas', data.code_cas);
